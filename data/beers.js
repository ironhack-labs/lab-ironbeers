module.exports = [
    {
        ...
        ingredients: {
            malt: [Array],
            hops: [Array],
            yeast: 'Wyeast 1056 - American AleÔäó'
        },
        food_pairing: [
    ...
    },
    {
        ...
        ingredients: {
            malt: [Array],
            hops: [Array],
            yeast: 'Wyeast 2007 - Pilsen LagerÔäó'
        },
        food_pairing: [
            'Spicy crab cakes',
    ...
    },
    {
        ...
        description: 'Re-brewed as a spring seasonal, this beer ÔÇô which appeared originally as an Equity Punk shareholder creation ÔÇô retains its trademark spicy, fruity edge. A perfect blend of Belgian Saison and US IPA, crushed peppercorns and heather honey are also added to produce a genuinely unique beer.',
        ...
        ingredients: {
            malt: [Array],
            hops: [Array],
            yeast: 'Wyeast 3711 - French SaisonÔäó'
        },
        food_pairing: [
    ...
    },
    {
        ...
        ingredients: {
            malt: [Array],
            hops: [Array],
            yeast: 'Wyeast 3522 - Belgian ArdennesÔäó'
        },
        food_pairing: [
    ...
    },
    {
        ...
        description: 'Fake is the new black. Fake is where it is at. Fake Art, fake brands, fake breasts, and fake lager. We want to play our part in the ugly fallout from the Lager Dream. Say hello to Fake Lager ÔÇô a zesty, floral 21st century faux masterpiece with added BrewDog bitterness.',
    ...
    },
    {
        ...
        brewers_tips: 'If you canÔÇÖt find really fresh cascade, substitute it for Amarillo or Ahtanum.',
        contributed_by: 'Sam Mason <samjbmason>'
    },
    {
        id: 14,
    ...
    },
    {
        ...
        ingredients: {
            malt: [Array],
            hops: [Array],
            yeast: 'Wyeast 1272 - American Ale IIÔäó'
        },
        food_pairing: [
    ...
    {
        id: 18,
        name: 'Russian Doll ÔÇô India Pale Ale',
    ...
    },
    {
        ...
        description: "We sent this beer to Norway where it was known as 'Hello, my name is CensoredÔÇÖ. You can make up your own mind as to why. This brew was a red berry explosion, with a reisnous bitter edge layered with dry berry tartness.",
        ...
        food_pairing: [
            'Fa╠èrika╠èl (mutton stew) with a spicy twist',
            'Fenala╠èr (salted cured lamb)',
    ...
    },
    {
        ...
        ingredients: {
            malt: [Array],
            hops: [Array],
            yeast: 'Wyeast 3333 - German WheatÔäó'
        },
        food_pairing: [
    ...
    },
    {
        ...
        ingredients: {
            malt: [Array],
            hops: [Array],
            yeast: 'Wyeast 3638 - Bavarian WheatÔäó'
        },
        food_pairing: [
